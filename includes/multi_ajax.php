...
function cms_formsubmit(){
	...
	global $api_username, $api_password, $api_signature, $api_version, $api_endpoint, $wpdb;
		...
		if ($result_array['ACK'] == 'Success') {
			...
			$msg = array('status' => false, 'type' => false, 'msg' => 'Something went wrong!',  'msg2' => $result_array, 'company' => $api_username, 'check' => $api_endpoint, 'username'=> $api_username , 'pas' => $api_password, 'sig' => $api_signature );
		}
