...
function display_function_1(){ ?>
    <input type="text" style="width: 300px" name="API_username" id="API_username" value="<?php echo get_option('API_username'); ?>" />
    <?php
}
function display_function_2(){ ?>
    <input type="text" style="width: 300px" name="API_password" id="API_password" value="<?php echo get_option('API_password'); ?>" />
    <?php
}
function display_function_3(){ ?>
    <input type="text" style="width: 300px" name="API_signature" id="API_signature" value="<?php echo get_option('API_signature'); ?>" />
    <?php
}
